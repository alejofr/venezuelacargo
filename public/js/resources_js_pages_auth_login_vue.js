...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    formChange: function formChange(event) {
      ...
      var type = this.user.email != "" && !this.$validator.errors.has('email') && this.user.password != '' && !this.$validator.errors.has('password') ? 'submit' : 'button';
      ...
      _c("div", { staticClass: "container h-100" }, [
        _c("div", { staticClass: "page-vzlc w-100 h-100" }, [
          _c(
            ...
            [
              _vm.alert.msg != "" && _vm.alert.clss != ""
                ? _c("alert", { attrs: { alert: _vm.alert, show: true } })
                : _vm._e(),
              _vm._v(" "),
                  ...
                  [
                      ...
                      _c("div", { staticClass: "col-6 mt-1" }, [
                        _c("label", { staticClass: "form-check mb-0" }, [
                          _c("input", {
                            ...
                            staticClass: "form-check-input check-input_0",
                            attrs: { type: "checkbox", value: "true" },
                            domProps: {
                              checked: Array.isArray(_vm.user.remenber)
                                ? _vm._i(_vm.user.remenber, "true") > -1
                                : _vm.user.remenber,
                            },
                            on: {
                              change: function ($event) {
                          ...
                          _c(
                            "span",
                            { staticClass: "form-check-label fs-14" },
                            [_vm._v("Recordarme")]
                          ),
                        ]),
                      ]),
                    ...
                    _c("div", { staticClass: "form-group d-md-flex" }, [
                      _c(
                        ...
                        [
                          _vm._v("¿No estás Registado?  "),
                          _c(
                            "router-link",
                            {
                              staticClass: "cl0 fw-bold fs-14 py-0 px-0",
                              attrs: { to: { name: "Registro" } },
                            },
...
var staticRenderFns = [
  ...
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "col-6 text-end mt-1" }, [
      _c(
        "a",
        {
          staticClass:
